...
insert into configuration(short,name,kind,val) value("active_clients","Activar clientes",1,1);
insert into configuration(short,name,kind,val) value("active_providers","Activar proveedores",1,1);
insert into configuration(short,name,kind,val) value("active_categories","Activar categorias",1,1);
insert into configuration(short,name,kind,val) value("active_reports_word","Activar reportes en Word",1,1);
insert into configuration(short,name,kind,val) value("active_reports_excel","Activar reportes en Excel",1,1);
insert into configuration(short,name,kind,val) value("active_reports_pdf","Activar reportes en PDF",1,1);

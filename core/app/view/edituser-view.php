...
<div class="row">
  ...
  <div class="form-group">
    <label for="inputEmail1" class="col-md-2 control-label">Nombre de usuario*</label>
    <div class="col-md-6">
  ...
  <div class="form-group">
    <label for="inputEmail1" class="col-md-2 control-label">Contrase&ntilde;a</label>
    <div class="col-md-6">
...
<p class="help-block">La contrase&ntilde;a solo se modificara si escribes algo, en caso contrario no se modifica.</p>
  ...
  <div class="form-group">
    <label for="inputEmail1" class="col-md-2 control-label" >Esta activo</label>
    <div class="col-md-6">
<div class="checkbox">
    <label>
  ...
  <div class="form-group">
    <label for="inputEmail1" class="col-md-2 control-label" >Es administrador</label>
    <div class="col-md-6">
<div class="checkbox">
    <label>
